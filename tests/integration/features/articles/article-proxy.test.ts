...
describe('Article Proxy Integration', () => {
  ...
  it('should use cache on subsequent requests', async () => {
    ...
    nock('https://en.wikipedia.org').get('/api/rest_v1/page/html/CacheTest').reply(304);
  ...
  it('should return 404 for invalid articles', async () => {
    nock('https://en.wikipedia.org').get('/api/rest_v1/page/html/Missing_Article').reply(404);
